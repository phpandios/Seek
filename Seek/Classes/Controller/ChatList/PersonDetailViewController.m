...
@interface PersonDetailViewController ()<UIActionSheetDelegate>
...
- (void)viewDidLoad {
    ...
    [self.ivAva sd_setImageWithURL:[NSURL URLWithString:self.userInfo.portraitUri] placeholderImage:[UIImage imageNamed:@"placeholderUserIcon"]];
