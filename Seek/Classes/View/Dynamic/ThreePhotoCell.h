...
@interface ThreePhotoCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *onePhotoH;//第一张照片高度
@property (weak, nonatomic) IBOutlet UIImageView *twoPhoto;//第二张照片
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *twoPhotoH;//第二张照片高度
